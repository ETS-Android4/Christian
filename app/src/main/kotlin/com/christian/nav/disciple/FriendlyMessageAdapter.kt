...
import com.christian.databinding.ItemImageMessageBinding
import com.christian.databinding.ItemMessageBinding
import com.christian.nav.disciple.DiscipleFragment.Companion.ANONYMOUS
    ...
    inner class MessageViewHolder(private val binding: ItemMessageBinding) :
        ...
        fun bind(item: FriendlyMessage) {
            ...
            if (item.photoUrl != null) {
                ...
                binding.messengerImageView.setImageResource(R.drawable.ic_account_circle_black_24dp)
            }
        }

 ...
 */
public class BlurViewExtendsConstraintLayout extends ConstraintLayout {

    private static final String TAG = BlurViewExtendsConstraintLayout.class.getSimpleName();
    ...
    public BlurViewExtendsConstraintLayout(Context context) {
        super(context);
        init(null, 0);
    }

    public BlurViewExtendsConstraintLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }

    public BlurViewExtendsConstraintLayout(Context context, AttributeSet attrs, int defStyleAttr) {
     ...
     * @return {@link BlurViewExtendsConstraintLayout} to setup needed params.
     */
